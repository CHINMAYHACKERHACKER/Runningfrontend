...

        {
            PARAM.VIDEONOISEREDUCE === "yes" ? (
                <JoLPlayer
                    ...
                    option={{
                        videoSrc: `/api/VIDEO/${PARAM.VIDEOFIVE}`,
                        theme,
                        ...
                        quality: [
                            {
                                name: "BD",
                                url: `/api/VIDEO/${PARAM.VIDEOONE}`
                            },
                            {
                                name: "FHD",
                                url: `/api/VIDEO/${PARAM.VIDEOTWO}`
                            },
                            {
                                name: "HD",
                                url: `/api/VIDEO/${PARAM.VIDEOTHREE}`
                            },
                            {
                                name: "SD",
                                url: `/api/VIDEO/${PARAM.VIDEOFIVE}`
                            }
                        ]
                    }}
                    style={{
