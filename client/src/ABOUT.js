    ...
    return (
        ...
        <div>
            ...
            <main>
                <ul>
                    <li>
                        upload video upto 30mb
                    </li>
                </ul>
                <ul>
                    {/* <li>In Vid Website There Are Three Features<br /> 1) Only Noise Reduction: This feature allows users to reduce background noise in their Videos(Select Only Video)<br />2) Noise Reduction+Background Music: This feature allows users to reduce background noise and add Background Music to Video(Select Both Video(mp4) and Audio(mp3) And Audio should be the same length of video)<br />3) Only Background Music: This feature allows users to add Background Music to Video without Noise Reduction(Select Both Video(mp4) and Audio(mp3) And Audio should be the same length of video).<br /><li>You can Upload Edited Video also But Dont Select Any Option Just Upload Edited Video.</li><br /><li>Dont Add Background Music In video When Selecting Only noise Reduction Option.</li><br /><li>After Uploading Your Video Pls Wait Until It Finish It Process After Finishing Process You Can Search Your Video With Your Video Title.</li><br /><li>Speak Little Louder If you are selecting noise reduction option.</li></li><br /> */}
